...
import config.db, crud.crud_servicio,  schemas.schema_servicio, models.model_servicio
...
async def read_servicio(skip: int = 0, limit: int = 100, db: Session = Depends(get_db)):
